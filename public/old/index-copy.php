    ...
    <div class='wrapper'>
        <div class="container">
            ...
            <div class="row border-white p-2 mt-2">
                ...
                <div class="row mt-4">
                    <div class="col-2">
                    <div class="row"><div class="col">Innings</div></div>
                    <div class="row"><div class="col mb-1 team-name">Vikings</div></div>
                    <div class="row"><div class="col team-name">Wildcats</div></div>
                    </div>
                    <div class="col-8">
                        <div class="row">
                            <div class="col">1</div>
